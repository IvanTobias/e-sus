TABELAS = [
    ...
    "DROP TABLE IF EXISTS diabetes CASCADE;",
    "DROP TABLE IF EXISTS diabetes_nominal CASCADE;",
    "DROP TABLE IF EXISTS equipes CASCADE;",
    "DROP TABLE IF EXISTS hipertensao CASCADE;",
    "DROP TABLE IF EXISTS hipertensao_nominal CASCADE;",
    "DROP TABLE IF EXISTS autorreferidos CASCADE;",
    "DROP TABLE IF EXISTS crianca CASCADE;",
    "DROP TABLE IF EXISTS idoso CASCADE;",
