#pylint: disable=line-too-long, W0311, C0302
import pytest
from src.infra.bridge_provider.tests.mocks.response_full import (
    response as login_response_,
)
...
def login():
  ...
  "extensions": {
    "tracing": {
      "version": 1,
      "startTime": "2024-09-30T20:57:44.745Z",
      "endTime": "2024-09-30T20:57:44.922Z",
      "duration": 177225348,
      "parsing": {
        "startOffset": 1967098,
        "duration": 1791357
...
@pytest.fixture
def login_profile_list():
    return {
      "id": "2866",
      "cpf": "11144477735",
      "cns": "898123456789123",
      "nome": "Enfereiro Sem Equipe",
      "conselhoClasse": None,
      "numeroConselhoClasse": None,
      "ufEmissoraConselhoClasse": None,
      "usuario": {
          "id": "2785",
          "aceitouTermosUso": True,
          "aceitouTermoTeleinterconsulta": False,
          "forcarTrocaSenha": False,
          "visualizouNovidades": False,
          "mostrarPesquisaSatisfacao": False,
          "notificaNovidadesVersao": True,
          "hashId": "8c2d3a751f9c73934441d16f9578d566e7dd7a2996a042f2ef047b5be926534c",
          "__typename": "Usuario"
      },
      "lotacoes": [
          {
              ...
              "unidadeSaude": {
                  "id": "4",
                  "nome": "ESF II Benigna Vilar de Carvalho",
          ...
          },
          {
              ...
              "unidadeSaude": {
                  "id": "5",
                  "nome": "ESF III Dr Jose de Anchieta Vilar de Queiroz",
                  "__typename": "UnidadeSaude"
              }
          }
      ],
